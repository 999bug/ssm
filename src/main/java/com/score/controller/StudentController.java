...
public class StudentController {
    ...
    public ResultObject<List<TStudent>> getUsers(TStudent student, @RequestParam("limit") int limit,
    ...
    public ResultObject<Object> deleteStudent(@RequestParam("studentNo") long studentNo) {
        Long total = studentService.deleteStudent(studentNo);
        //统一返回
        ResultObject<Object> rs = new ResultObject<Object>();
        if (null == total || 0 == total) {
            rs.setCode(Constant.FAILURE_RETUEN_CODE);
